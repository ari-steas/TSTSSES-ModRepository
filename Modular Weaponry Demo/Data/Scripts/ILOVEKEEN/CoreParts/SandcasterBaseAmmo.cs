...
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EjectionDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EjectionDef.SpawnType;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.ShapeDef.Shapes;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.DamageScaleDef.CustomScalesDef.SkipMode;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.FragmentDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.PatternDef.PatternModes;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.FragmentDef.TimedSpawnDef.PointTypes;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.Conditions;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.UpRelativeTo;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.FwdRelativeTo;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.ReInitCondition;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.RelativeTo;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.ConditionOperators;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.StageEvents;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.GuidanceType;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.DamageScaleDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.DamageScaleDef.ShieldDef.ShieldType;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.DamageScaleDef.DeformDef.DeformTypes;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.AreaOfDamageDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.AreaOfDamageDef.Falloff;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.AreaOfDamageDef.AoeShape;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EwarDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EwarDef.EwarMode;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EwarDef.EwarType;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EwarDef.PushPullDef.Force;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef.LineDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef.LineDef.FactionColor;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef.LineDef.TracerBaseDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef.LineDef.Texture;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef.DecalDef;
using static Scripts.ILOVEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.DamageScaleDef.DamageTypes.Damage;

namespace ILOVEKEEN.Scripts
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef SandcasterBaseAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
