    ...
    partial class Parts {
        ...
        WeaponDefinition SandcasterBase => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Caster_FocusLens", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "Empty", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RateOfFire = 360, // Set this to 3600 for beam weapons. This is how fast your gun fires per minute.
            ...
            Ammos = new[] {
                SandcasterBaseAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
