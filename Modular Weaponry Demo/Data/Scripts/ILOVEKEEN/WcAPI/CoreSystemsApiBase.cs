...
namespace CoreSystems.Api
{
    ...
    public partial class WcApi
    {
        ...
        /// </summary>
        /// <param name="block"></param>
        public float GetRofMultiplier(MyEntity block) => _getRofMultiplier?.Invoke(block) ?? -1;
        ...
        /// <param name="block"></param>
        /// <param name="multiplier"></param>
        public float GetBaseDmgMultiplier(MyEntity block) => _getBaseDmgMultiplier?.Invoke(block) ?? -1;
        ...
        /// <param name="block"></param>
        /// <param name="multiplier"></param>
        public float GetAreaDmgMultiplier(MyEntity block) => _getAreaDmgMultiplier?.Invoke(block) ?? -1;
        ...
        /// <param name="block"></param>
        /// <param name="multiplier"></param>
        public float GetAreaRadiusMultiplier(MyEntity block) => _getAreaRadiusMultiplier?.Invoke(block) ?? -1;
        ...
        /// <param name="block"></param>
        /// <param name="multiplier"></param>
        public float GetVelocityMultiplier(MyEntity block) => _getVelocityMultiplier?.Invoke(block) ?? -1;
