...
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EjectionDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EjectionDef.SpawnType;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.ShapeDef.Shapes;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.DamageScaleDef.CustomScalesDef.SkipMode;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.FragmentDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.PatternDef.PatternModes;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.FragmentDef.TimedSpawnDef.PointTypes;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.Conditions;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.UpRelativeTo;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.FwdRelativeTo;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.ReInitCondition;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.RelativeTo;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.ConditionOperators;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef.StageEvents;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.ApproachDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.TrajectoryDef.GuidanceType;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.DamageScaleDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.DamageScaleDef.ShieldDef.ShieldType;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.DamageScaleDef.DeformDef.DeformTypes;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.AreaOfDamageDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.AreaOfDamageDef.Falloff;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.AreaOfDamageDef.AoeShape;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EwarDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EwarDef.EwarMode;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EwarDef.EwarType;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.EwarDef.PushPullDef.Force;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef.LineDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef.LineDef.FactionColor;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef.LineDef.TracerBaseDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef.LineDef.Texture;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.GraphicDef.DecalDef;
using static Scripts.IHATEKEEN.CoreParts.script.Structure.WeaponDefinition.AmmoDef.DamageScaleDef.DamageTypes.Damage;
