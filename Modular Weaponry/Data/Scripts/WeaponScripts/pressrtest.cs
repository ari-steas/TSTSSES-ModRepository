...
using VRage;
using Modular_Weaponry.Data.Scripts.WeaponScripts; // Make sure this namespace matches with WeaponDefinition's namespace
...
public class IncreaseTurretDamageScript : MySessionComponentBase
{
    ...
    private void IncreaseTurretDamage()
    {
        ...
        foreach (var projId in projectileIds)
        {
            ...
            WeaponDefiniton.ChangeProjectileData(0, 0, projId, 0, projectileState.Item2);  // Assuming default values for entity and part IDs
        }
